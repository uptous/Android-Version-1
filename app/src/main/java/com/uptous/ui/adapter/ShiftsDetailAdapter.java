 ...
 * Created by Prakash .
 */
public class ShiftsDetailAdapter extends RecyclerView.Adapter<ShiftsDetailAdapter.VersionViewHolder> {
    ...
    public ShiftsDetailAdapter(Activity a, List<SignUpDetailResponseModel.ItemsBean.VolunteersBean> listEntities) {
