...
public class SignUpOngoingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private SignUpOngoingAdapter mSignUpOngoingAdapter;
...
//
                        ...
                        mSignUpOngoingAdapter = new SignUpOngoingAdapter(SignUpOngoingActivity.this,
                                eventResponseModels.get(0).getItems());
                        mRecyclerViewOpenSpot.setAdapter(mSignUpOngoingAdapter);


                    } else {
                        Toast.makeText(SignUpOngoingActivity.this, "" + response.raw().code(), Toast.LENGTH_SHORT).show();
                    }
