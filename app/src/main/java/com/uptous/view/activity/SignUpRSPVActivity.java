...
/**
 * FileName : SignUpRSPVActivity
 * Description :show all RSPV sign_up open spots, volunteer, full.
...
//                                        .into(mViewOrganizerOneRoundedImageView);
                                ...
                                Glide.with(SignUpRSPVActivity.this).load(eventResponseModels.get(0).getOrganizer1PhotoUrl())
                                        .into(mViewOrganizerOneRoundedImageView);
                            }
...
//                                        .into(mViewOrganizerSecondRoundedImageView);
                                ...
                                Glide.with(SignUpRSPVActivity.this).load(eventResponseModels.get(0).getOrganizer2PhotoUrl())
                                        .into(mViewOrganizerSecondRoundedImageView);
                            }
