...
public class SignUpVoteActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView mTextViewTitle, mViewEventDescriptionTextView, mViewOrganizerOneTextView,
            ...
            mTextViewSecondNameContactOne, mTextViewSecondNameContactTwo, mTextViewFirstNameContactTwo;
                             ...
                             try {
                                 ...
                                 if (response.isSuccessful()) {
                                     ...
                                     if (val == 0) {
                                         ...
                                         Toast.makeText(SignUpVoteActivity.this, "" + response.raw().code(), Toast.LENGTH_SHORT).show();
                                     }
