...
import com.uptous.view.adapter.SignUpVoteAdapter;
...
/**
 * FileName : SignUpVoteActivity
 * Description :show all Vote sign_up open spots, volunteer, full.
 * Dependencies : SignUpVoteActivity
 */

public class SignUpVoteActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private SignUpVoteAdapter mSignUpVoteAdapter;
    ...
    protected void onResume() {
        ...
        if (ConnectionDetector.isConnectingToInternet(this)) {
            ...
            Toast.makeText(SignUpVoteActivity.this, R.string.network_error, Toast.LENGTH_SHORT).show();
        }
...
//        }
    ...
    private void getApiSignUpDetail() {
        ...
        final ProgressDialog mProgressDialog = new ProgressDialog(SignUpVoteActivity.this);
...
//                                             Picasso.with(SignUpVoteActivity.this).load(eventResponseModels.get(0).getOrganizer1PhotoUrl())
//                                                     .into(mViewOrganizerOneRoundedImageView);

                                             Glide.with(SignUpVoteActivity.this).load(eventResponseModels.get(0).getOrganizer1PhotoUrl())
                                                     .into(mViewOrganizerOneRoundedImageView);
                                         }
                                     ...
                                     if (Image2 != null) {
                                         ...
                                         if (mResultTwo.equalsIgnoreCase("gif")) {
                                             ...
                                             if (BackgroundColor != null) {
                                                 ...
                                                 String resultContact1LastName = eventResponseModels.get(0).getContact2().
                                                         substring(eventResponseModels.get(0).getContact2().lastIndexOf(' ') + 1).trim();
...
//                                             Picasso.with(SignUpVoteActivity.this).load(eventResponseModels.get(0).getOrganizer2PhotoUrl())
//                                                     .into(mViewOrganizerSecondRoundedImageView);


                                             Glide.with(SignUpVoteActivity.this).load(eventResponseModels.get(0).getOrganizer2PhotoUrl())
                                                     .into(mViewOrganizerSecondRoundedImageView);
                                         }
...
//                                }
                                     ...
                                     final CustomizeDialog customizeDialog = new CustomizeDialog(SignUpVoteActivity.this);
                             ...
                             {
                                 mProgressDialog.dismiss();
                                 Toast.makeText(SignUpVoteActivity.this, R.string.error, Toast.LENGTH_SHORT).show();
