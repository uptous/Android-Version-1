 ...
 * Created by Prakash .
 */
public class AnnouncementsListAdapter extends RecyclerView.Adapter<AnnouncementsListAdapter.VersionViewHolder> {

    List<GetAllAnnouncementResponseModel> listEntities;
    Activity activity;


    public AnnouncementsListAdapter(Activity a, List<GetAllAnnouncementResponseModel> listEntities) {
