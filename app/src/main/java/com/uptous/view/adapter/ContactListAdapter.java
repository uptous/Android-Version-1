...
//        }
        ...
        ContactListResponseModel contactListResponseModel = listEntities.get(i);
        String firstName = contactListResponseModel.getFirstName();
        contactListResponseModel.getLastName();
...
//        int colorText = Color.parseColor(listEntities.get(i).getMemberTextColor());
    ...
    public void addData(List<ContactListResponseModel> body) {
        listEntities.add((ContactListResponseModel) body);
