...
import com.uptous.view.activity.RSVPDetailActivity;
...
public class SignUpRsvpAdapter extends RecyclerView.Adapter<SignUpRsvpAdapter.VersionViewHolder> {
    ...
    public SignUpRsvpAdapter(Activity a, List<SignUpDetailResponseModel.ItemsBean> listEntities) {
    ...
    @Override
    public SignUpRsvpAdapter.VersionViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view =
                LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_rsvp_sign_up, viewGroup, false);
        SignUpRsvpAdapter.VersionViewHolder viewHolder = new SignUpRsvpAdapter.VersionViewHolder(view);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final SignUpRsvpAdapter.VersionViewHolder versionViewHolder, int i) {
        ...
        if (OpenSpot.equalsIgnoreCase("Open")) {
            ...
            versionViewHolder.linearLayoutrow_parent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(activity, RSVPDetailActivity.class);
            ...
            if (OpenSpot.equalsIgnoreCase("Volunteered")) {
                ...
                versionViewHolder.linearLayoutrow_parent.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        int ItemId = listEntities.get(position).getId();
                        Prefs.setName(activity,listEntities.get(position).getName());
                        Prefs.setSignUpType(activity,"RSVP");
                        Prefs.setItemId(activity,ItemId);
                ...
                versionViewHolder.mTextViewVolunteered.setText("Responded");
            }
