 ...
 * Created by Prakash .
 */
public class SignUpPartyAdapter extends RecyclerView.Adapter<SignUpPartyAdapter.VersionViewHolder> {
    ...
    public SignUpPartyAdapter(Activity a, List<SignUpDetailResponseModel.ItemsBean> listEntities) {
...
//        versionViewHolder.mTextViewDate.setText(dateText);
    ...
    class VersionViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout linearLayoutVolunteered, linearLayoutOpenSpot, layout_parent;
