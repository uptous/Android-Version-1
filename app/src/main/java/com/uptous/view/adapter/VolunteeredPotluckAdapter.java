 ...
 * Created by Prakash .
 */
public class VolunteeredPotluckAdapter extends RecyclerView.Adapter<VolunteeredPotluckAdapter.VersionViewHolder> {
    ...
    public VolunteeredPotluckAdapter(Activity a, List<SignUpDetailResponseModel.ItemsBean.VolunteersBean> listEntities) {
